...
namespace MyBK.Lib.Request {
    class MyBKStInfo {
        ...
        public String getBangDiem() {
            String str = str = POST.sendPOST("http://www.aao.hcmut.edu.vn/stinfo/lichthi/ajax_grade", _token, cookieSession);
            return str; // JSON
        }
   
        public String getTienDoHocTap() {
            String str = str = POST.sendPOST("http://www.aao.hcmut.edu.vn/stinfo/lichthi/ajax_ctdt", _token, cookieSession);
            return str; // JSON
        }

        public String getTienDoHocTap() {
            String str = str = POST.sendPOST("http://www.aao.hcmut.edu.vn/stinfo/profile", _token, cookieSession);
            return str; // HTML/XML
        }
